...
plt.pie(manufacturer_stock_value_plot, labels=manufacturer_stock_value_plot.index, autopct='%1.1f%%', startangle=140, rotatelabels=True, pctdistance=0.85) # Rotate labels and adjust percentage distance
